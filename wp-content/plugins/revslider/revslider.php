...
update_option( 'revslider-code', 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'revslider-trustpilot', 'false');
update_option( 'revslider-deregister-popup', 'false');
define('RS_REVISION',			'6.6.18');
...
define('RS_TP_TOOLS',			'6.6.18'); //holds the version of the tp-tools script, load only the latest!
...
try{
	...
	function rev_slider_shortcode($args, $mid_content = null){
		...
		$sc_attr = array_map('wp_kses_post', $sc_attr);
